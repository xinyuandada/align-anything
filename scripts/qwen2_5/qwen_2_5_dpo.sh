...
TRAIN_DATASETS="/data/zhangyanhong-2401220256/align_anything_t2t/format" # dpo dataset path
...
OUTPUT_DIR="${OUTPUT_ROOT_DIR}/qwen_2_5_dpo/5_14_one-epoch" # output dir
